...
export function Footer({ categories = [] }: FooterProps) {
  ...
  return (
    <footer className={`pt-12 md:pt-16 pb-8 ${isDark ? 'bg-navy-dark text-white' : 'bg-bella-100 text-navy'}`}>
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className={`text-sm leading-relaxed ${isDark ? 'text-bella-400' : 'text-bella-600'}`}>{t('heroSubtitle')}</p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-4 text-sm md:text-base">{t('quickLinks')}</h4>
            <ul className={`space-y-2 text-sm ${isDark ? 'text-bella-400' : 'text-bella-600'}`}>
              {[
                { href: '/', label: t('home') },
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              {/* Instagram */}
              <a href="https://www.instagram.com/bella_gcc_" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-full flex items-center justify-center hover:bg-gold transition-colors ${isDark ? 'bg-navy-light' : 'bg-bella-200'}`}>
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@bellabathwares" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-full flex items-center justify-center hover:bg-gold transition-colors ${isDark ? 'bg-navy-light' : 'bg-bella-200'}`}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* X (Twitter) */}
              <a href="https://x.com/bella_gcc" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-full flex items-center justify-center hover:bg-gold transition-colors ${isDark ? 'bg-navy-light' : 'bg-bella-200'}`}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              {/* WhatsApp */}
              <a href="https://wa.me/971566851447" target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-full flex items-center justify-center hover:bg-green-500 transition-colors ${isDark ? 'bg-navy-light' : 'bg-bella-200'}`}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`border-t pt-6 text-center text-xs md:text-sm ${isDark ? 'border-navy-light text-bella-500' : 'border-bella-200 text-bella-600'}`}>
